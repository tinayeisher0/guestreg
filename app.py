...
def load_css():
    st.markdown(
        ...
        .block-container {max-width: 980px; padding-top: 0.2rem; padding-bottom: 0.5rem;}
        ...
        .stButton > button {
            ...
            box-shadow: 0 10px 25px rgba(17,24,39,0.22) !important;
            opacity: 1 !important;
        ...
        .kiosk-btn button:hover,
        .kiosk-btn button:focus,
        .kiosk-btn button:active,
        ...
        @media (max-width: 900px) {
            .block-container {padding-top: 0.08rem !important; padding-bottom: 0.25rem !important;}
            .logo-zone {margin: 0.1rem 0 0.2rem 0 !important;}
            .compact-title {font-size: 1.1rem !important; margin-bottom: 0.1rem !important;}
            .muted {font-size: 0.85rem !important;}
            .kiosk-btn button, .stButton > button {min-height: 58px !important; padding: 0.55rem 0.8rem !important; font-size: 0.96rem !important;}
            .small-note {font-size: 0.78rem !important; margin-top: 0.15rem !important;}
            .qr-title {font-size: 0.78rem !important; margin-bottom: 0.22rem !important;}
            .qr-image {width: 110px !important; padding: 8px !important;}
        ...
        @media (max-width: 640px) {
            ...
            .logo-zone img {max-width: 82vw !important;}
            .kiosk-btn button, .stButton > button {min-height: 54px !important; font-size: 0.92rem !important;}
            .qr-image {width: 96px !important;}
        }
        </style>
        ''',
...
def home_screen():
    ...
    show_logo(500)
    render_flash_banner()
    st.markdown("<div class='compact-title' style='margin-top:0.05rem; margin-bottom:0.35rem;'>Welcome to Embrace</div>", unsafe_allow_html=True)
    r1 = st.columns(2)
    with r1[0]:
